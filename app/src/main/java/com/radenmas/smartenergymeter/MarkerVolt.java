...
public class MarkerVolt extends MarkerView {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        if (e instanceof CandleEntry) {
            ...
            tvVolt.setText(Utils.formatNumber(ce.getHigh(), 0, true)+ " V");
        } else {
            float time = e.getX();
            String jam = sdf.format(time);
            tvTime.setText(jam);
            tvVolt.setText(Utils.formatNumber(e.getY(), 0, true) + " V");
        }
